...
public class Testcase3 
{
		...
		public void Login_Search_ClickFirstProduct_AddToWishlist()
		{
			...
			boolean b=a5.continue_shopping_button_display();
			Assert.assertTrue(b);
			//WebElement continueshopping_buton= driver.findElement(By.id("continue-shopping"));
			//Assert.assertTrue(continueshopping_buton.isDisplayed());
			//Assert.assertEquals("Product not wishlisted", true, continueshopping_buton.isDisplayed());
		}
